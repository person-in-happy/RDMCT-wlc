...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| HEM | full | cie_core_nominal | 8_to_32_wafers_nominal_processing | 60 | 1 | 0.6 | 224.4+/-260.6 | 224.6 | 0.01611 | 488.5 | 4690 | 1.326 | 1.676e+04 | 263.6 | n/a |
| HEM + Beam | full | cie_core_nominal | 8_to_32_wafers_nominal_processing | 60 | 1 | 0.6 | 224.4+/-260.6 | 224.6 | 0.01921 | 488.5 | 4690 | 1.326 | 1.676e+04 | 263.6 | n/a |
| HEM + Structure | full | cie_core_nominal | 8_to_32_wafers_nominal_processing | 60 | 1 | 0.6333 | 221.5+/-253.2 | 221.6 | 0.02842 | 463.6 | 4570 | 1.332 | 1.689e+04 | 258.8 | n/a |
| Proposed | full | cie_core_nominal | 8_to_32_wafers_nominal_processing | 60 | 1 | 0.6333 | 221.5+/-253.2 | 221.7 | 0.02373 | 463.6 | 4570 | 1.332 | 1.689e+04 | 258.8 | n/a |
| 23D Features Only | full | cie_core_nominal | 8_to_32_wafers_nominal_processing | 60 | 1 | 0.6 | 224.4+/-260.6 | 224.6 | 0.02478 | 488.5 | 4690 | 1.326 | 1.675e+04 | 262.6 | n/a |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| HEM | 60 | 60 | 1/1 | 29 | 0.4833 | -38.13 | 0.1447 | 0.579 |
| HEM + Beam | 60 | 60 | 1/1 | 24 | 0.4 | -52.11 | 0.2805 | 0.7881 |
| HEM + Structure | 60 | 60 | 1/1 | 21 | 0.35 | 8.933 | 0.2627 | 0.7881 |
| 23D Features Only | 60 | 60 | 1/1 | 22 | 0.3667 | -55.37 | 0.2933 | 0.7881 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| HEM | 60 | -10.27% | 60 | -0.00628 | 35 | -23.45% |
| HEM + Beam | 60 | -10.27% | 60 | -0.006514 | 35 | -21.18% |
| HEM + Structure | 60 | 0% | 60 | 0 | 38 | -0.2863% |
| 23D Features Only | 60 | -10.27% | 60 | -0.006394 | 35 | -21.62% |
...
| --- | --- | ---: | ---: | ---: | ---: |
| beam_without_structure | HEM -> HEM + Beam | 49 | 0.5306 | 12.55% | 0.0001336% |
| structure_with_greedy | HEM -> HEM + Structure | 49 | 0.551 | -42.75% | 0.005124% |
| structure_with_beam | HEM + Beam -> Proposed | 47 | 0.5106 | -52.11% | 0.005303% |
| beam_with_structure | HEM + Structure -> Proposed | 47 | 0.4468 | 8.933% | 0% |
