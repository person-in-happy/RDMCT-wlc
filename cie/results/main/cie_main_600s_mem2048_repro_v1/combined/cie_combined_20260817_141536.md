...
| HEM | full | cie_core_nominal | 8_to_32_wafers_nominal_processing | 500 | 1 | 0.624 | 219.6+/-255.4 | 219.8 | 0.03157 | 467.9 | 4579 | 1.272 | 1.682e+04 | 265.3 | 1.157 [1.083, 1.238] |
| HEM + Beam | full | cie_core_nominal | 8_to_32_wafers_nominal_processing | 500 | 1 | 0.624 | 219.9+/-255.6 | 220.1 | 0.04191 | 468.2 | 4579 | 1.272 | 1.683e+04 | 265.3 | 1.144 [1.07, 1.223] |
| HEM + Structure | full | cie_core_nominal | 8_to_32_wafers_nominal_processing | 500 | 1 | 0.632 | 218.4+/-253.8 | 218.6 | 0.044 | 461.4 | 4504 | 1.26 | 1.66e+04 | 265.3 | 1.376 [1.166, 1.661] |
| Proposed | full | cie_core_nominal | 8_to_32_wafers_nominal_processing | 500 | 1 | 0.632 | 218.3+/-253.8 | 218.5 | 0.05195 | 461.3 | 4504 | 1.26 | 1.659e+04 | 264.5 | 1.367 [1.154, 1.653] |
| 23D Features Only | full | cie_core_nominal | 8_to_32_wafers_nominal_processing | 500 | 1 | 0.626 | 219.4+/-256.4 | 219.6 | 0.03419 | 466.4 | 4534 | 1.253 | 1.662e+04 | 266.2 | 1.217 [1.114, 1.342] |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| SCIP | 500 | 500 | 1/1 | 169 | 0.338 | -15.17 | 0.8024 | 0.8024 |
| HEM | 500 | 500 | 1/1 | 218 | 0.436 | -20.57 | 0.01017 | 0.06104 |
| HEM + Beam | 500 | 500 | 1/1 | 203 | 0.406 | -15.69 | 0.02868 | 0.1434 |
| HEM + Structure | 500 | 500 | 1/1 | 188 | 0.376 | 7.654 | 0.1943 | 0.5829 |
| adaptive_cutsel | 500 | 500 | 1/1 | 198 | 0.396 | -21.59 | 0.3042 | 0.6083 |
| 23D Features Only | 500 | 500 | 1/1 | 210 | 0.42 | -40 | 0.03857 | 0.1543 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| SCIP | 500 | -15.71% | 500 | -0.06471 | 297 | -17.63% |
| HEM | 500 | -10.2% | 500 | 0.01223 | 298 | -12.23% |
| HEM + Beam | 500 | -10.2% | 500 | 0.01173 | 298 | -9.722% |
| HEM + Structure | 500 | -1.162% | 500 | 0.0002193 | 315 | -3.35% |
| adaptive_cutsel | 500 | -11.12% | 500 | 0.0117 | 297 | -39.96% |
| 23D Features Only | 500 | -12% | 500 | -0.006847 | 297 | -19.69% |
...
| --- | --- | ---: | ---: | ---: | ---: |
| beam_without_structure | HEM -> HEM + Beam | 402 | 0.4328 | 6.283% | 0% |
| structure_with_greedy | HEM -> HEM + Structure | 402 | 0.505 | -21.04% | 0.001305% |
| structure_with_beam | HEM + Beam -> Proposed | 401 | 0.5062 | -15.69% | 0.005303% |
| beam_with_structure | HEM + Structure -> Proposed | 405 | 0.4642 | 7.654% | 0% |
