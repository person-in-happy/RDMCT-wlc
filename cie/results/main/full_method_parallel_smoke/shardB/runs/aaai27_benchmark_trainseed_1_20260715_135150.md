...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| adaptive_cutsel | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 0+/-0 | 0 | 610 | 0 | 0 | 58 | n/a |
| HEM | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 1+/-0 | 1 | 610 | 0 | 2.623 | 58 | 0 [0, 0] |
| HEM + Beam | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 0+/-0 | 0 | 610 | 0 | 0 | 58 | n/a |
| HEM + Structure | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 1+/-0 | 1 | 610 | 0 | 100 | 58 | 0 [0, 0] |
| Proposed | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 0+/-0 | 0 | 610 | 0 | 0 | 58 | n/a |
| 23D Features Only | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 1+/-0 | 1 | 610 | 0 | 100 | 58 | 0 [0, 0] |
| SCIP | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 0+/-0 | 0 | 610 | 0 | 0 | 58 | n/a |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| SCIP | 1 | 1 | 1/1 | 0 | 0 | n/a | n/a | n/a |
| HEM | 1 | 1 | 1/1 | 1 | 1 | 100 | n/a | n/a |
| HEM + Beam | 1 | 1 | 1/1 | 0 | 0 | n/a | n/a | n/a |
| HEM + Structure | 1 | 1 | 1/1 | 1 | 1 | 100 | n/a | n/a |
| adaptive_cutsel | 1 | 1 | 1/1 | 0 | 0 | n/a | n/a | n/a |
| 23D Features Only | 1 | 1 | 1/1 | 1 | 1 | 100 | n/a | n/a |
...
| HEM + Structure | 1 | 0% | 1 | 0 | 1 | 100% |
| adaptive_cutsel | 1 | 0% | 1 | 0 | 0 | n/a% |
| 23D Features Only | 1 | 0% | 1 | 0 | 1 | 100% |
...
| structure_with_greedy | HEM -> HEM + Structure | 1 | 0 | -3712% | -3712% |
| structure_with_beam | HEM + Beam -> Proposed | 0 | n/a | n/a% | n/a% |
| beam_with_structure | HEM + Structure -> Proposed | 1 | 1 | 100% | 100% |
