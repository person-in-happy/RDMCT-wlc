...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| adaptive_cutsel | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 1+/-0 | 1 | 610 | 0 | 100 | 94 | 0 [0, 0] |
| HEM | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 1+/-0 | 1 | 610 | 0 | 2.623 | 94 | 0 [0, 0] |
| HEM + Beam | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 1+/-0 | 1 | 610 | 0 | 100 | 94 | 0 [0, 0] |
| HEM + Structure | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 1+/-0 | 1 | 610 | 0 | 2.623 | 94 | 0 [0, 0] |
| Proposed | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 0+/-0 | 0 | 610 | 0 | 0 | 94 | n/a |
| 23D Features Only | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 0+/-0 | 0 | 610 | 0 | 0 | 94 | n/a |
| SCIP | cie_core_nominal | 8_to_32_wafers_nominal_processing | 1 | 1 | 1 | 0+/-0 | 0 | 610 | 0 | 0 | 94 | n/a |
...
| HEM + Beam | 1 | 1 | 1/1 | 1 | 1 | 100 | n/a | n/a |
| HEM + Structure | 1 | 1 | 1/1 | 1 | 1 | 100 | n/a | n/a |
| adaptive_cutsel | 1 | 1 | 1/1 | 1 | 1 | 100 | n/a | n/a |
...
| SCIP | 1 | 0% | 1 | 0 | 0 | n/a% |
| HEM | 1 | 0% | 1 | 0 | 1 | 100% |
| HEM + Beam | 1 | 0% | 1 | 0 | 1 | 100% |
| HEM + Structure | 1 | 0% | 1 | 0 | 1 | 100% |
| adaptive_cutsel | 1 | 0% | 1 | 0 | 1 | 100% |
...
| --- | --- | ---: | ---: | ---: | ---: |
| beam_without_structure | HEM -> HEM + Beam | 1 | 0 | -3712% | -3712% |
| structure_with_greedy | HEM -> HEM + Structure | 1 | 0 | 0% | 0% |
| structure_with_beam | HEM + Beam -> Proposed | 1 | 1 | 100% | 100% |
